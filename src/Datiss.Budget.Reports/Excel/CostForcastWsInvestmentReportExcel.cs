...
{
    public static class CostForcastWsInvestmentReportExcel
    {
        private const string _sheetName = "CostForcastWsInvestmentReport";

        public static XLWorkbook ExportExcel (this IEnumerable<CostForcastWsInvestmentReportDTO> items)
        {
        ...
        public static XLWorkbook GetImportTemplate(this IEnumerable<CostForcastWsInvestmentReportDTO> items, int year)
        {
            if (items == null || !items.Any())
                return null;
