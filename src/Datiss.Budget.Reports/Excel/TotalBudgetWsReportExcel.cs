...
{
    public static class TotalBudgetWsReportExcel
    {
        private const string _sheetName = "TotalBudgetWsReport";

        public static XLWorkbook ExportExcel(this IEnumerable<TotalBudgetWsReportDTO> items)
        {
        ...
        public static XLWorkbook GetImportTemplate(this IEnumerable<TotalBudgetWsReportDTO> items, int year)
        {
            if (items == null || !items.Any())
                return null;
