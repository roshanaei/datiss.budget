...
{
    public static class IncomeCurrentCofficientExcel
    {
        private const string _sheetName = "IncomeCurrentCofficient";

        public static XLWorkbook ExportExcel(this IEnumerable<IncomeCurrentCofficientDTO> items)
        {
            ...
            sheet.Cell(1, 5).Value = "ضریب آب";
            sheet.Cell(1, 6).Value = "ضریب فاضلاب";
            ...
            for (int i = 0; i < totalCount; i++)
            {
                ...
                sheet.Cell(row, 6).Value = item.FeeWs;
        ...
        public static XLWorkbook GetImportTemplate(this IEnumerable<IncomeCurrentCofficientDTO> items, int year)
        {
            if (items == null || !items.Any())
                return null;
            ...
            sheet.Cell(2, 7).Value = "ضریب آب";
            sheet.Cell(2, 8).Value = "ضریب فاضلاب";
