...
namespace Datiss.Budget.Reports.Excel
{
    public static class CostCurrentReportExcel
    {
        ...
        public static XLWorkbook ExportExcel(this IEnumerable<CostCurrentReportDTO> items)
        {
            ...
            sheet.Cell(1, 5).Value = "عنوان";
            sheet.Cell(1, 6).Value = "پیش بینی سال بودجه";
        ...
        public static XLWorkbook GetImportTemplate(this IEnumerable<CostCurrentReportDTO> items, int year)
        {
            ...
            sheet.Cell(2, 7).Value = "عنوان";
            sheet.Cell(2, 8).Value = "کد عنوان";
            ...
            for (int i = 0; i < totalCount; i++)
            {
                ...
                sheet.Cell(row, 7).Value = item.UnitDetailTypeDisplay;
                sheet.Cell(row, 8).Value = item.UnitDetailTypeId;
