...
namespace Datiss.Budget.Reports.Excel
{
    public static class AverageContractedCapacityNHUsesExcel
    {
        ...
        public static XLWorkbook GetImportTamplate(this IEnumerable<AverageContractedCapacityNHUsesDTO> items, int year)
        {
            if (items == null || !items.Any())
                return null;
            ...
            sheet.Cell(2, 7).Value = "درآمد سرمایه ای متوسط ظرفیت قراردادی آب";
            sheet.Cell(2, 8).Value = "درآمد سرمایه ای متوسط ظرفیت قراردادی فاضلاب";
            ...
            range.Column(6).Style.NumberFormat.Format = "#,##0.00";
