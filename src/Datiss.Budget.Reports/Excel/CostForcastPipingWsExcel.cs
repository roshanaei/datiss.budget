...
namespace Datiss.Budget.Reports.Excel
{
    ...
    public static class CostForcastPipingWsExcel
    {
        private const string _sheetName = "CostForcastPipingWs";

        public static XLWorkbook ExportExcel(this IEnumerable<CostForcastPipingWsDTO> items)
        {
            ...
            sheet.Cell(1, 6).Value = "هزینه اجرا نقب";
            sheet.Cell(1, 7).Value = "هزینه اجرا ترانشه";
            ...
            for (int i = 0; i < totalCount; i++)
            {
                ...
                sheet.Cell(row, 6).Value = item.NaghabCost;
                ...
                sheet.Cell(row, 7).Value = item.TeransheCost;
        ...
        public static XLWorkbook GetImportTemplate(this IEnumerable<CostForcastPipingWsDTO> items, int year)
        {
            if (items == null || !items.Any())
                return null;
            ...
            sheet.Cell(2, 8).Value = "هزینه اجرا نقب";
            sheet.Cell(2, 9).Value = "هزینه اجرا ترانشه";
