...
{
    public static class CostForcastConsumptionReportExcel
    {
        private const string _sheetName = "CostForcastConsumptionReport";

        public static XLWorkbook ExportExcel(this IEnumerable<CostForcastConsumptionReportDTO> items)
        {
        ...
        public static XLWorkbook GetImportTemplate(this IEnumerable<CostForcastConsumptionReportDTO> items, int year)
        {
            if (items == null || !items.Any())
                return null;
