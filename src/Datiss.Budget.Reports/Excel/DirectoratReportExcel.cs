...
{
    public static class DirectoratReportExcel
    {
        private const string _sheetName = "DirectoratReport";

        public static XLWorkbook ExportExcel(this IEnumerable<DirectoratReportDTO> items)
        {
        ...
        public static XLWorkbook GetImportTemplate(this IEnumerable<DirectoratReportDTO> items, int year)
        {
            if (items == null || !items.Any())
                return null;
