...
namespace Datiss.Budget.Reports.Excel
{
    ...
    public static class CostCurrentWaterSourcePriceExcel
    {
        private const string _sheetName = "CostCurrentWaterSourcePrice";

        public static XLWorkbook ExportExcel(this IEnumerable<CostCurrentWaterSourcePriceDTO> items) {
            ...
            sheet.Cell(1, 3).Value = "منبع تولید";
        ...
        public static XLWorkbook GetImportTemplate(this IEnumerable<CostCurrentWaterSourcePriceDTO> items, int year) {
            if (items == null || !items.Any())
                return null;
            ...
            sheet.Cell(2, 3).Value = "منبع تولید";
