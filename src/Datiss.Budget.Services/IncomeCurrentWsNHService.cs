...
namespace Datiss.Budget.Services
{
    public class IncomeCurrentWsNHService : IIncomeCurrentWsNHService
    {
        ...
        public async Task<OrganizationDeleteDataResult> HardDeleteAsync(int yearId, int organizationId)
        {
            ...
            IEnumerable<IncomeCurrentWsNH> childrens = new IncomeCurrentWsNH[] { };
        ...
        {
            var data = await _excelService.ImportAsync<IncomeCurrentWsNHImportModel>
                (fileInfo, sheetIndex: 0, minRowNum: 2);

            var records = data.Adapt<List<IncomeCurrentWsNH>>();
        ...
        public async Task<IEnumerable<IncomeCurrentWsNHDTO>> GetExportItemsAsync(int yearId, int organizationId)
        {
        ...
        private async Task<IEnumerable<IncomeCurrentWsNH>> getChildrenData(
