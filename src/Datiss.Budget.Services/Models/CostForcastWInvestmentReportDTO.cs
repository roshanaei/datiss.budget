...
{
    public class CreateCostForcastWInvestmentReportDTO
    {
    ...
    public class UpdateCostForcastWInvestmentReportDTO : CreateCostForcastWInvestmentReportDTO
    {
        public int Id { get; set; }
    }

    public class CostForcastWInvestmentReportDTO
    {
        public int Id { get; set; }
        public int YearId { get; set; }
