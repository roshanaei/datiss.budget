...
{
    public class CreateCostForcastConstructionWsDTO
    {
    ...
    public class UpdateCostForcastConstructionWsDTO : CreateCostForcastConstructionWsDTO
    {
        public int Id { get; set; }

    }

    public class CostForcastConstructionWsDTO
    {
        public int Id { get; set; }
        public int YearId { get; set; }
