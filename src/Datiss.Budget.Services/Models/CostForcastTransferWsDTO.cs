...
{
    public class CreateCostForcastTransferWsDTO
    {
    ...
    public class UpdateCostForcastTransferWsDTO : CreateCostForcastTransferWsDTO
    {
        public int Id { get; set; }

    }

    public class CostForcastTransferWsDTO
    {
        public int Id { get; set; }
