...
namespace Datiss.Budget.Services.Models
{
    ...
    public class CostForcastWsInvestmentReportFilterDTO : FilterInputDTO
    {
        public int? YearId { get; set; }
        public int? NumberYear { get; set; }
        public int? OrganizationId { get; set; }
    ...
    public class CostForcastConsumptionReportFilterDTO : FilterInputDTO
    {
        public int? YearId { get; set; }
        public int? OrganizationId { get; set; }
        public int? NumberYear { get; set; }
    ...
    public class TotalBudgetWReportFilterDTO : FilterInputDTO
    {
        public int? YearId { get; set; }
        public int? OrganizationId { get; set; }
        public int? NumberYear { get; set; }
    ...
    public class DirectoratReportFilterDTO : FilterInputDTO
    {
        public int? YearId { get; set; }
        public int? OrganizationId { get; set; }
        public int? NumberYear { get; set; }
