...
{
    public class CostCurrentSharingSetadService : ICostCurrentSharingSetadService
    {
        ...
        private readonly DbSet<CostCurrentSharingSetad> _dbSet;
        private readonly DbSet<Organization> _orgDbSet;
        private readonly DbSet<FinanceYear> _yearSet;

        public CostCurrentSharingSetadService(
            ...
            IOrganizationService organizationService)
        {
            ...
            _dbSet = _uow.Set<CostCurrentSharingSetad>();
        ...
        private IQueryable<CostCurrentSharingSetad> Query()
            => _dbSet.AsNoTracking();

        public async Task<CostCurrentSharingSetad> GetByIdAsync(int id)
        {
            var entity = await _dbSet.FindAsync(id);
            return await Task.FromResult(entity);
        }

        public async Task<ValidationResult<CostCurrentSharingSetadDTO>> CreateAsync(CreateCostCurrentSharingSetadDTO model)
        {
            model.CheckArgumentIsNull(nameof(model));

            var entity = new CostCurrentSharingSetad
            {
                YearId = model.YearId,
            ...
            try
            {
                if (await checkLogicAsync(model.YearId, model.OrganizationId))
                {
                    ...
                    {
                        return ValidationResult<CostCurrentSharingSetadDTO>.Failed(
            ...
            {
                return ValidationResult<CostCurrentSharingSetadDTO>.Failed(ServiceMessages.Logic_InputDisableYearData);
            }
        ...
        public async Task<ValidationResult<CostCurrentSharingSetadDTO>> UpdateAsync(UpdateCostCurrentSharingSetadDTO model)
        {
            model.CheckArgumentIsNull(nameof(model));
            ...
            try
            {
                if (await checkLogicAsync(model.YearId, model.OrganizationId, model.Id))
                {
                    ...
                    var result = new CostCurrentSharingSetadDTO
                    {
                        OrganizationId = model.OrganizationId,
                        YearId = model.YearId,
                        WUnit = model.WUnit,
        ...
        public async Task<OrganizationDeleteDataResult> HardDeleteAsync(int yearId, int organizationId)
        {
            ...
            IEnumerable<CostCurrentSharingSetad> childrens = new CostCurrentSharingSetad[] { };
        ...
        public async Task<IEnumerable<CalculationItemData>> CalculationAsync(int yearId, int organizationId)
        {
            ...
            {
                Key = "CostCurrentSharingSetads_Cal1",
                Value = await _uow.ExecuteScalar<int>(
                        "[dbo].[CostCurrentSharingSetads_Cal1] @YearId, @OrganizationId",
        ...
        public async Task<PagedResult<CostCurrentSharingSetadDTO>> GetListAsync(CostCurrentSharingSetadFilterDTO filter)
        {
            filter.CheckArgumentIsNull(nameof(filter));

            var result = new PagedResult<CostCurrentSharingSetadDTO>
            {
            ...
            result.Items = await query.Include(x => x.FinanceYear)
                                    ...
                                    .Select(x => new CostCurrentSharingSetadDTO
                                    {
                                        Id = x.Id,
        ...
        public async Task CopyAsync(int sourceYearId, int sourceOrgId, int destYearId)
        {
            ...
            var result = new List<CostCurrentSharingSetad>();
        ...
        {
            var data = await _excelService.ImportAsync<CostCurrentSharingSetadImportModel>
                (fileInfo, sheetIndex: 0, minRowNum: 2);

            var records = data.Adapt<List<CostCurrentSharingSetad>>();
        ...
        public async Task<IEnumerable<CostCurrentSharingSetadDTO>> GetExportItemsAsync(int yearId, int organizationId)
        {
        ...
        public async Task<Stream> ExportExcelAsync(CostCurrentSharingSetadFilterDTO filter)
        {
            filter.CheckArgumentIsNull(nameof(filter));
        ...
        private async Task<IQueryable<CostCurrentSharingSetad>> setFilter(
            IQueryable<CostCurrentSharingSetad> query,
            CostCurrentSharingSetadFilterDTO filter)
        {
            query.CheckArgumentIsNull(nameof(query));
            filter.CheckArgumentIsNull(nameof(filter));

            var predicate = PredicateBuilder.New<CostCurrentSharingSetad>();
        ...
        private IQueryable<CostCurrentSharingSetad> setOrder(
           IQueryable<CostCurrentSharingSetad> query,
           string orderBy = "id",
           bool desc = false)
        {
        ...
        private async Task<IEnumerable<CostCurrentSharingSetad>> getChildrenData(
        ...
        private async Task<IEnumerable<CostCurrentSharingSetad>> getChildren(
            int parentOrganizationId,
            int yearId)
        {
            var children = await _orgDbSet
