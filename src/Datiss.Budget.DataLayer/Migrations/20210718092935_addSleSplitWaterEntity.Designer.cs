...
namespace Datiss.Budget.DataLayer.Migrations
{
    ...
    [Migration("20210718092935_addSleSplitWaterEntity")]
    partial class addSleSplitWaterEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Datiss.Budget.Entities.DWH.SalesSplitWater", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Datiss.Budget.Entities.DWH.SalesSplitWater", b =>
                {
                    ...
                    b.HasOne("Datiss.Budget.Entities.Constant", "UserType")
                        .WithMany("UserTypeSalesSplitW")
                        .HasForeignKey("UserTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Datiss.Budget.Entities.Constant", "WPipeDiameter")
                        .WithMany("WaterPipeDiameterSalesSplitW")
            ...
            modelBuilder.Entity("Datiss.Budget.Entities.Constant", b =>
                {
                    ...
                    b.Navigation("UserTypeSalesSplitW");

                    b.Navigation("WasteInstallFees");

                    b.Navigation("WaterInstallFees");

                    b.Navigation("WaterPipeDiameterSalesSplitW");
                });

            modelBuilder.Entity("Datiss.Budget.Entities.FinanceYear", b =>
                {
                    b.Navigation("SalesSplitW_Ys");
