...
namespace Datiss.Budget.Web.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class BudgetSourceReportController : Controller
    {
        public const string Name = "BudgetSourceReport";
        ...
        private readonly ILogger<BudgetSourceReportController> _logger;
        private readonly IWebHostEnvironment _env;
        private readonly IBudgetSourceReportService _budgetSourceReportService;
        ...
        public BudgetSourceReportController(
            ILogger<BudgetSourceReportController> logger,
            IWebHostEnvironment environment,
            IBudgetSourceReportService budgetSourceReportService,
            ...
            ISecurityTrimmingService securityTrimmingService)
        {
            ...
            _budgetSourceReportService = budgetSourceReportService ?? throw new ArgumentNullException(nameof(budgetSourceReportService));
        ...
        public async Task<IActionResult> Edit(UpdateBudgetSourceReportViewModel model)
        {
            ...
            var data = model.Adapt<UpdateBudgetSourceReportDTO>();
            var result = await _budgetSourceReportService.UpdateAsync(data);
            ...
            return Json(
                result.Result.Adapt<BudgetSourceReportViewModel>()
            );
        }
        ...
        public async Task<IActionResult> Index(int page = 1)
        {
            ...
            var myfilter = TempData.Get<BudgetSourceReportFilterViewModel>(_indexFilterKey);
            if (myfilter != null)
            {
                filter = myfilter.Adapt<BudgetSourceReportFilterDTO>();
                TempData.Put(_indexFilterKey, myfilter);
            }

            filter.PageNumber = page;

            var result = await _budgetSourceReportService.GetListAsync(filter);
            var model = result.Adapt<BudgetSourceReportIndexViewModel>();
        ...
        public async Task<IActionResult> Index(BudgetSourceReportIndexViewModel model)
        {
            var filter = model.Filter.Adapt<BudgetSourceReportFilterDTO>();

            TempData.Put(_indexFilterKey, filter);

            var result = await _budgetSourceReportService.GetListAsync(filter);
            model = result.Adapt<BudgetSourceReportIndexViewModel>();
            model.Filter = filter.Adapt<BudgetSourceReportFilterViewModel>();
        ...
        public async Task<IActionResult> DeleteRecords(int yearId, int orgId)
        {
            try
            {
                var result = await _budgetSourceReportService.HardDeleteAsync(yearId, orgId);
        ...
        public async Task<IActionResult> Copy(CopyViewModel model)
        {
            ...
            try
            {
                await _budgetSourceReportService.CopyAsync(
                                                    model.SourceYearId,
                                                    model.SourceOrgId,
                                                    model.TargetYearId);
        ...
        public async Task<IActionResult> ImportExcel(ImportExcelViewModel model)
        {
            ...
            try
            {
                var result = await _budgetSourceReportService.ImportExcelAsync(
                                                                    model.ExcelFile,
                                                                    model.YearId,
