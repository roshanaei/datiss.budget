...
namespace Datiss.Budget.Web.Controllers
{
    ...
    {
        public const string Name = "SalesSplitTotal";
        ...
        private readonly ILogger<SalesSplitTotalController> _logger;
        private readonly IWebHostEnvironment _env;
        private readonly ISalesSplitTotalService _salesSplitTotalService;
        ...
        public SalesSplitTotalController(
            ILogger<SalesSplitTotalController> logger,
            IWebHostEnvironment environment,
            ISalesSplitTotalService waterSaleSplitService,
            ...
            )
        {
            ...
            _salesSplitTotalService = waterSaleSplitService ?? throw new ArgumentNullException(nameof(_salesSplitTotalService));
        ...
        public async Task<IActionResult> Create(CreateSalesSplitTotalViewModel model)
        {
            ...
            var data = model.Adapt<CreateSalesSplitTotalDTO>();

            var result = await _salesSplitTotalService.CreateAsync(data);
            ...
            return Json(result.Result.Adapt<SalesSplitTotalViewModel>());
        }
        ...
        public async Task<IActionResult> Edit(UpdateSalesSplitTotalViewModel model)
        {
            ...
            var data = model.Adapt<UpdateSalesSplitTotalDTO>();
            var result = await _salesSplitTotalService.UpdateAsync(data);
            ...
            return Json(
                result.Result.Adapt<SalesSplitTotalViewModel>()
            );
        }
        ...
        public async Task<IActionResult> Index(int page = 1)
        {
            ...
            var myfilter = TempData.Get<SalesSplitTotalFilterViewModel>(_indexFilterKey);
            if (myfilter != null)
            {
                filter = myfilter.Adapt<SalesSplitTotalFilterDTO>();
                TempData.Put(_indexFilterKey, myfilter);
            }

            filter.PageNumber = page;

            var result = await _salesSplitTotalService.GetListAsync(filter);
            var model = result.Adapt<SalesSplitTotalIndexViewModel>();
        ...
        public async Task<IActionResult> Index(SalesSplitTotalIndexViewModel model)
        {
            var filter = model.Filter.Adapt<SalesSplitTotalFilterDTO>();

            TempData.Put(_indexFilterKey, filter);

            var result = await _salesSplitTotalService.GetListAsync(filter);
            model = result.Adapt<SalesSplitTotalIndexViewModel>();
            model.Filter = filter.Adapt<SalesSplitTotalFilterViewModel>();
        ...
        public async Task<IActionResult> ImportExcel(ImportExcelViewModel model)
        {
            ...
            try
            {
                var result = await _salesSplitTotalService.ImportExcelAsync(
                                                                    model.ExcelFile,
                                                                    model.YearId,
        ...
        public async Task<IActionResult> DeleteRecords(int yearId, int orgId)
        {
            try
            {
                var result = await _salesSplitTotalService.HardDeleteAsync(yearId, orgId);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                await _salesSplitTotalService.HardDeleteAsync(id);
            }
            catch (DisbaledYearDataInputException)
            {
                return Json(new
        ...
        public async Task<IActionResult> Calculation(CalculationInputViewModel model)
        {
            ...
            var result = await _salesSplitTotalService.CalculationAsync(
                model.YearId,
        ...
        public async Task<IActionResult> Copy(CopyViewModel model)
        {
            ...
            try
            {
                await _salesSplitTotalService.CopyAsync(
                                                    model.SourceYearId,
                                                    model.SourceOrgId,
                                                    model.TargetYearId);
        ...
        public async Task<IActionResult> GetExcelTemplate(int yearId, int? orgId)
        {
            ...
            var items = new List<SalesSplitTotalDTO>();
            ...
            foreach (var org in organizations)
            {
                foreach (var usert in userTypes)
                {
                    ...
                    items.Add(new SalesSplitTotalDTO
                    {
            ...
            return workbook.Deliver("SalesSplitTotal-Import-Template.xlsx");
        }

        [HttpGet("[action]/{orgid}/{yearid}")]
        public async Task<IActionResult> ExportExcel(int orgid, int yearid)
        {
            var result = await _salesSplitTotalService.GetExportItemsAsync(yearid, orgid);
            if (result.Count() == 0)
                return RedirectToAction("Index");
            using var workbook = result.ExportExcel();
            return workbook.Deliver("SalesSplitTotal.xlsx");
        }
        ...
        private string getCalcTitle(string key)
            => key switch
            {
                "SalesSplitTotal_Cal1" => SPTitles.SalesSplitTotal_Cal1,
                "SalesSplitTotal_Cal2" => SPTitles.SalesSplitTotal_Cal2,
                "SalesSplitTotal_Cal3" => SPTitles.SalesSplitTotal_Cal3,
                "SalesSplitTotal_Cal4" => SPTitles.SalesSplitTotal_Cal4,
                "SalesSplitTotal_Cal5" => SPTitles.SalesSplitTotal_Cal5,
                "SalesSplitTotal_Cal6" => SPTitles.SalesSplitTotal_Cal6,
                "SalesSplitTotal_Cal7" => SPTitles.SalesSplitTotal_Cal7,
                "SalesSplitTotal_Cal8" => SPTitles.SalesSplitTotal_Cal8,
                _ => ""
            };
        #endregion
    }
