...
namespace Datiss.Budget.Web.Controllers
{
    ...
    public class IncomeForcastWsController : Controller
    {
        ...
        public async Task<IActionResult> Index(IncomeForcastWsIndexViewModel model, int page = 1)
        {
        ...
        {
            var filePath = $"{_env.WebRootPath}\\Excel\\IncomeForcastWsImport.xlsx";

            var stream = new FileStream(filePath, FileMode.Open, FileAccess.Read);
            return File(
                stream,
                "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
                "IncomeForcastWs.xlsx");
        }
