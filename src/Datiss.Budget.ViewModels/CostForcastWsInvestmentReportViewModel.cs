...
{
    public class UpdateCostForcastWsInvestmentReportViewModel :BaseViewModel
    {
    ...
    public class CostForcastWsInvestmentReportViewModel 
    {
        public int Id { get; set; }
        public int YearId { get; set; }
        public string YearDisplay { get; set; }
    ...
    public class CostForcastWsInvestmentReportFilterViewModel : FilterViewModel
    {
        public int? YearId { get; set; }
    ...
    public class CostForcastWsInvestmentReportIndexViewModel : PagedViewModel<CostForcastWsInvestmentReportViewModel>
    {

        public CostForcastWsInvestmentReportIndexViewModel()
        {
            Filter = new CostForcastWsInvestmentReportFilterViewModel();
        }

        public CostForcastWsInvestmentReportFilterViewModel Filter { get; set; }
        public IList<SelectListItem> YearSource { get; set; }
        public IList<SelectListItem> OrganizationSource { get; set; }
