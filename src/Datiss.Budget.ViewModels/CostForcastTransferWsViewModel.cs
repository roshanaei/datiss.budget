...
{
    public class CreateCostForcastTransferWsViewModel : BaseViewModel
    {
        ...
        public IEnumerable<SelectListItem> MethodTypeSource { get; set; }
    ...
    public class UpdateCostForcastTransferWsViewModel : CreateCostForcastTransferWsViewModel
    {
        public int Id { get; set; }

    }

    public class CostForcastTransferWsViewModel
    {
        public int Id { get; set; }
        ...
        public int MethodTypeId { get; set; }
        public string MethodTypeDisplay { get; set; }
    ...
    public class CostForcastTransferWsFilterViewModel : FilterViewModel
    {
        public int? YearId { get; set; }
        public int? OrganizationId { get; set; }
    ...
    public class CostForcastTransferWsIndexViewModel : PagedViewModel<CostForcastTransferWsViewModel>
    {

        public CostForcastTransferWsIndexViewModel()
        {
            Filter = new CostForcastTransferWsFilterViewModel();
        }

        public CostForcastTransferWsFilterViewModel Filter { get; set; }
        ...
        public IList<SelectListItem> MethodTypeSource { get; set; }
        ...
        public void SeMethodTypeSource(IEnumerable<DropDownItemViewModel> source)
            => MethodTypeSource = source.Select(x => new SelectListItem
            {
                Text = x.Title,
                Value = x.Id.ToString()
            }).ToList();
    ...
    public class CostForcastTransferWsImportViewModel : PagedViewModel<CostForcastTransferWsViewModel>
    {
        public IList<DropDownItemViewModel> TransferTypeSource { get; set; }
        public IList<DropDownItemViewModel> DigTypeSource { get; set; }
        public IList<DropDownItemViewModel> MethodTypeSource { get; set; }
