...
{
    public class UpdateDirectoratReportViewModel : BaseViewModel
    {
    ...
    public class DirectoratReportViewModel
    {
        public int Id { get; set; }
        public int YearId { get; set; }
    ...
    public class DirectoratReportFilterViewModel : FilterViewModel
    {
        public int? YearId { get; set; }
    ...
    public class DirectoratReportIndexViewModel : PagedViewModel<DirectoratReportViewModel>
    {

        public DirectoratReportIndexViewModel()
        {
            Filter = new DirectoratReportFilterViewModel();
        }

        public DirectoratReportFilterViewModel Filter { get; set; }
        public IList<SelectListItem> YearSource { get; set; }
        public IList<SelectListItem> OrganizationSource { get; set; }
