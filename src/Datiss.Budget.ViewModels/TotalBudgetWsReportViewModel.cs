...
{
    public class UpdateTotalBudgetWsReportViewModel : BaseViewModel
    {
    ...
    public class TotalBudgetWsReportViewModel
    {
        public int Id { get; set; }
        public int YearId { get; set; }
    ...
    public class TotalBudgetWsReportFilterViewModel : FilterViewModel
    {
        public int? YearId { get; set; }
    ...
    public class TotalBudgetWsReportIndexViewModel : PagedViewModel<TotalBudgetWsReportViewModel>
    {

        public TotalBudgetWsReportIndexViewModel()
        {
            Filter = new TotalBudgetWsReportFilterViewModel();
        }

        public TotalBudgetWsReportFilterViewModel Filter { get; set; }
        public IList<SelectListItem> YearSource { get; set; }
        public IList<SelectListItem> OrganizationSource { get; set; }
