...
{
    public class UpdateCostForcastConsumptionReportViewModel : BaseViewModel
    {
    ...
    public class CostForcastConsumptionReportViewModel
    {
        public int Id { get; set; }
        public int YearId { get; set; }
    ...
    public class CostForcastConsumptionReportFilterViewModel : FilterViewModel
    {
        public int? YearId { get; set; }
    ...
    public class CostForcastConsumptionReportIndexViewModel : PagedViewModel<CostForcastConsumptionReportViewModel>
    {

        public CostForcastConsumptionReportIndexViewModel()
        {
            Filter = new CostForcastConsumptionReportFilterViewModel();
        }

        public CostForcastConsumptionReportFilterViewModel Filter { get; set; }
        public IList<SelectListItem> YearSource { get; set; }
        public IList<SelectListItem> OrganizationSource { get; set; }
