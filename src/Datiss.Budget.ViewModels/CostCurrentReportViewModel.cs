...
{
    public class UpdateCostCurrentReportViewModel : BaseViewModel
    {
    ...
    public class CostCurrentReportViewModel
    {
        public int Id { get; set; }
        public int YearId { get; set; }
    ...
    public class CostCurrentReportFilterViewModel : FilterViewModel
    {
        public int? YearId { get; set; }
    ...
    public class CostCurrentReportIndexViewModel : PagedViewModel<CostCurrentReportViewModel>
    {

        public CostCurrentReportIndexViewModel()
        {
            Filter = new CostCurrentReportFilterViewModel();
        }

        public CostCurrentReportFilterViewModel Filter { get; set; }
        public IList<SelectListItem> YearSource { get; set; }
        public IList<SelectListItem> OrganizationSource { get; set; }
