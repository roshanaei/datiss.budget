...
namespace Datiss.Budget.ViewModels
{
    public class CreateCostCurrentConstructionWViewModel : BaseViewModel
    {
        ...
        public IEnumerable<SelectListItem> WaterInvestorsTypeSource { get; set; }
    ...
    public class CostCurrentConstructionWIndexViewModel : PagedViewModel<CostCurrentConstructionWViewModel>
    {
        ...
        public IList<SelectListItem> WaterInvestorsTypeSource { get; set; }
        ...
        public void SetWaterInvestorsTypeSource(IEnumerable<DropDownItemViewModel> source)
            => WaterInvestorsTypeSource = source.Select(x => new SelectListItem
            {
                Text = x.Title,
                Value = x.Id.ToString()
            }).ToList();
